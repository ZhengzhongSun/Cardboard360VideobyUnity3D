...
1. Unity 5 additional iOS Support


Fixed 2.28

1. Modify Unity 5.0 support
2. Reduction plug-resource capacity


Fixed 2.25
1.Sample video path change
2.Add GetCurrentState () function

Fixed 2.24
1.Update split demo

Fixed 2.23
1. Full Screen modified prefab
2. Sphere demo MIRROR modified
3. Fix a memory leak iOS
4. Modify a white screen when playing back after iOS Loop


Fixed 2.22
1. GL State Recovery Bug Fixes

Fixed 2.21
1. plan to include Android Source (jar source only the public, NDK source private)
2. Delete unnecessary files
3.Material modify the setting is wrong in the Sphere Demo

Fixed 2.20
 1. Fix Black Screen issue of Tegra3 chipset 
 2.Fix iOS screen upside down phenomenon 
 3. rochchip chipset optimized 
 4. Seek function bug fix for iOS 
 5.Modify RawImage bug in Unity 4.6 ugui 
